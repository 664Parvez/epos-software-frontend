                                ...
                                <>
                                    {
                                        ...
                                        <div className="col-lg-4 col-md-6 mt-3">
                                            <div className='p-3 rounded-3' style={{background: "var(--second-color)"}}>
                                ...
                                <>
                                    {
                                        ...
                                        <div className="col-lg-4 col-md-6 mt-3">
                                            <div className='p-3 rounded-3' style={{background: "var(--forth-color)"}}>
                                                <div className='d-flex justify-content-between align-items-center'>
                                                    <div>
                                                        <h5>Table: {items.table}</h5>
                                                    </div>
                                ...
                                <>
                                    {
                                        ...
                                        <div className="col-lg-4 col-md-6 mt-3">
                                            <div className='p-3 rounded-3' style={{background: "var(--black-color)", color: "var(--white-color)"}}>
                                                <div className='d-flex justify-content-between align-items-center'>
                                                    <div>
                                                        <h5>Table: {items.table}</h5>
                                                    </div>
